  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between bg-[#3b3552] text-white px-4 sm:px-6 py-3 shadow-md border-b border-[#5a5270]">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {/* Dropdown */}
        {showDropdown && admin && !loading && (
          <div className="absolute right-0 mt-3 w-72 bg-white text-gray-800 rounded-lg shadow-xl border border-gray-200 p-5">
      ...
      {/* Mobile Menu */}
      {showMenu && (
        <div className="absolute top-full left-0 w-full bg-[#3b3552] border-t border-[#5a5270] flex flex-col items-start p-4 sm:hidden">
          <button
